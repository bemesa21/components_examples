defmodule ComponentsExamplesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ComponentsExamplesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ComponentsExamplesWeb.Gettext, "errors", msg, opts)
    end
  end
